...
class collect_latlongs():

    def __init__(self):
        self.download_zip(zip_url, zip_filename)
        self.extract_zip(zip_filename, '.')
        self.reformat_zipcode_data(extracted_filename, output_file)
        self.clean_up(zip_filename, extracted_filename)
    ...
    def extract_zip(self, zip_filename, extract_to):
    ...
    def reformat_zipcode_data(self, input_file, output_file):
    ...
    def clean_up(self, zip_filename, extracted_filename):
        print("Cleaning up...")
        with zipfile.ZipFile(zip_filename, 'r') as zip_ref:
